      ...
      {isEnglish() ? (
        <div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
          ...
          <main className="cover">
            ...
            <p className="text-justify">
              I'm also a senior DBA with 8+ years of solid experience working
              with Data Mining and Business Intelligence Technologies and over 1
              year working on Web Development and Web Design as a Freelance.
            </p>
            {/* quote */}
            ...
            <p className="text-justify">
              ...
              passion lies in making responsive web apps using React.js and
              overall UX Design.
            </p>
            {/* socials */}
        ...
        <div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
          ...
          <main className="cover">
            ...
            <p className="text-justify">
              ...
              equipo de Desarrollo Web Full Stack.
            </p>
            <p className="text-justify">
              También soy un DBA senior con más de 8 años de experiencia
              trabajando en Minería de Datos, Inteligencia de Negocios y más de
              1 año trabajando en Desarrollo y Diseño Web como Freelance.
            </p>
            {/* quote */}
            <div className="blockquote text-center">
              <p className="mb-0" id="quote">
            ...
            <p className="text-justify">
              ...
              radica en crear aplicaciones web responsivas utilizando React.js y
              la UX en general.
            </p>
            {/* socials */}
            <div className="d-flex justify-content-center mt-4">
