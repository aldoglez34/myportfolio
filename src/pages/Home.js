                ...
                <div className="cover-container d-flex flex-column p-3 mx-auto w-100 h-100">
                    ...
                    <footer className="mastfoot mt-auto mb-3">
                        <div className="d-flex flex-row justify-content-center">
                            <a href="/spa" className="lang mr-4">Español</a>
                            <a href="/eng" className="lang activelang ml-4">English</a>
                        </div>
                    </footer>
                </div>
                    ...
                    <div className="cover-container d-flex flex-column p-3 mx-auto w-100 h-100">
                        ...
                        <footer className="mastfoot mt-auto mb-3">
                            <div className="d-flex flex-row justify-content-center">
                                <a href="/spa" className="lang activelang mr-4">Español</a>
                                <a href="/eng" className="lang ml-4">English</a>
                            </div>
                        </footer>
                    </div>
